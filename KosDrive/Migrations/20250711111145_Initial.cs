        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessLicensePicture = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    RepresentantiveIdPicture = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CompanyLogoPicture = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    Subscription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MaxAllowedVehicles = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastActivatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DriversLicensePicture = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    FrontCarLicensePlatePicture = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    BackCarLicensePlatePicture = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ...
                    PreferedPaymentMethod = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IdentificationCardPicture = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteDrivers", x => new { x.RiderId, x.DriverId });
                    table.CheckConstraint("NO_CASCADE", "1=1");
                    table.ForeignKey(
                        name: "FK_FavoriteDriver_Driver",
                        column: x => x.DriverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FavoriteDriver_Rider",
                        column: x => x.RiderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RiderRating = table.Column<int>(type: "int", nullable: true),
                    RiderReview = table.Column<int>(type: "int", nullable: true),
                    DriverRating = table.Column<int>(type: "int", nullable: true),
                    DriverReview = table.Column<string>(type: "nvarchar(max)", nullable: true),
